...
export declare namespace EnergyCertificate {
...
export interface EnergyCertificateInterface extends Interface {
  ...
  encodeFunctionData(
    ...
    values: [AddressLike, EnergyCertificate.CertificateDataStruct]
  ): string;
...
export interface EnergyCertificate extends BaseContract {
  ...
  authorizedMinter: TypedContractMethod<[], [string], "view">;
  ...
  getCertificate: TypedContractMethod<
    [tokenId: BigNumberish],
    [EnergyCertificate.CertificateDataStructOutput],
    "view"
  >;
  ...
  mint: TypedContractMethod<
    [to: AddressLike, data: EnergyCertificate.CertificateDataStruct],
    [bigint],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "authorizedMinter"
  ...
  filters: {
    ...
    "CertificateIssued(uint256,address,uint256,uint256)": TypedContractEvent<
      CertificateIssuedEvent.InputTuple,
      CertificateIssuedEvent.OutputTuple,
      CertificateIssuedEvent.OutputObject
    >;
